    ...
    return (
        <>
            <div className=" mx-auto lgl:px-20 py-24 flex flex-col items-center">
                ...
                <div className='w-full mt-6 xl:h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark lgl:h-[80vh] sml:h-[60vh] sm:h-[50vh] 
