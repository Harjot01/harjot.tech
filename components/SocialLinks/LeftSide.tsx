    ...
    return (
        <motion.div
            ...
            <div className="flex flex-col gap-4">
                <Link href={`${socialLink.githubProfile}`} target="_blank">
                ...
                <Link
                    href={`${socialLink.leetcodeProfile}`}
                    target="_blank"
                >
                    <span className="w-10 h-10 text-xl bg-secondary dark:bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen  cursor-pointer hover:-translate-y-2 transition-all duration-300">
                ...
                <Link
                    href={`${socialLink.hackerrankProfile}`}
                    target="_blank"
                >
                    <span className="w-10 h-10 text-xl  bg-secondary dark:bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                ...
                <Link href={`${socialLink.linkedinProfile}`} target="_blank">
                    <span className="w-10 h-10 text-xl  bg-secondary dark:bg-hoverColor  rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                        <IoLogoLinkedin aria-label="Linkedin Icon" />
                    </span>
                </Link>
                <Link href={`${socialLink.instagramProfile}`} target="_blank">
                    <span className="w-10 h-10 text-xl  bg-secondary dark:bg-hoverColor  rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
